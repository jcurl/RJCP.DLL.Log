namespace RJCP.Diagnostics.Log.Constraints
{
    ...
    /// </summary>
    public sealed class TextEquals : IMatchConstraint
    {
        private readonly string m_Text;

        /// <summary>
        /// Initializes a new instance of the <see cref="TextEquals"/> class.
        /// </summary>
        ...
        {
            return line.Text.Equals(m_Text, StringComparison.Ordinal);
        }
    }
}
