namespace RJCP.App.DltDump.Domain.Dlt.Pcap.Ng
{
    public static class PcapBlocks
    {
        ...
        // Time stamp assumes microseconds - 2020-06-17 12:37:30.970622000   0x0005A846, 0xEC6805FE
        public static readonly byte[] EpbData = new byte[] {
        ...
        // Time stamp assumes microseconds - 2020-06-17 12:37:30.970622000   0x0005A846, 0xEC6805FE
        public static readonly byte[] EpbDataBigEndian = new byte[] {
        ...
        // Time stamp assumes nanoseconds - 2020-06-17 12:37:30.970622498
        public static readonly byte[] EpbDataNano = new byte[] {
            0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x55, 0x19, 0x16,
            0x22, 0x6A, 0x57, 0x76, 0x65, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00,
        ...
        // Time stamp assumes nanoseconds - 2020-06-17 12:37:30.970622498
        public static readonly byte[] EpbDataNanoBigEndian = new byte[] {
            0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x00, 0x16, 0x19, 0x55, 0x0B,
            0x76, 0x57, 0x6A, 0x22, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00, 0x65,
        ...
        // Time stamp assumes microseconds - 2020-06-17 12:37:30.970622000   0x0005A846, 0xEC6805FE
        public static readonly byte[] EpbDataIntf1 = new byte[] {
            0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x46, 0xA8, 0x05, 0x00,
            0xFE, 0x05, 0x68, 0xEC, 0x65, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00,
        ...
        // Time stamp assumes microseconds - 2020-06-17 12:37:30.970622000   0x0005A846, 0xEC6805FE
        public static readonly byte[] EpbDataIntf1BigEndian = new byte[] {
            0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0xA8, 0x46,
            0xEC, 0x68, 0x05, 0xFE, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00, 0x65,
        ...
        // Time stamp assumes nanoseconds - 2020-06-17 12:37:30.970622498
        public static readonly byte[] EpbDataNanoIntf1 = new byte[] {
            0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x0B, 0x55, 0x19, 0x16,
            0x22, 0x6A, 0x57, 0x76, 0x65, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00,
        ...
        // Time stamp assumes nanoseconds - 2020-06-17 12:37:30.970622498
        public static readonly byte[] EpbDataNanoIntf1BigEndian = new byte[] {
            0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x88, 0x00, 0x00, 0x00, 0x01, 0x16, 0x19, 0x55, 0x0B,
            0x76, 0x57, 0x6A, 0x22, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00, 0x65,
