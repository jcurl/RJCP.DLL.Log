namespace RJCP.App.DltDump.Domain.Dlt
{
    ...
    /// </summary>
    public class DltNetworkTraceFilterReaderFactory : TraceReaderFactory<DltTraceLineBase>
    {
        ...
        /// </summary>
        public DltNetworkTraceFilterReaderFactory(IOutputStream outputStream, bool online)
        {
        ...
        {
            return new DltNetworkTraceFilterDecoder(m_OutputStream, m_Online);
        }
    }
}
