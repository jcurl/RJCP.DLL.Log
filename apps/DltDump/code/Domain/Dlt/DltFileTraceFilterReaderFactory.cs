namespace RJCP.App.DltDump.Domain.Dlt
{
    ...
    /// </summary>
    public class DltFileTraceFilterReaderFactory : TraceReaderFactory<DltTraceLineBase>
    {
        ...
        /// </summary>
        public DltFileTraceFilterReaderFactory(IOutputStream outputStream)
        {
        ...
        {
            return new DltFileTraceFilterDecoder(m_OutputStream);
        }
    }
}
