namespace RJCP.Diagnostics.Log.Dlt.Control
{
    ...
    /// </summary>
    public class SetDefaultLogLevelResponseDecoder : IControlArgDecoder
    {
        /// <summary>
        ...
        public int Decode(int serviceId, ReadOnlySpan<byte> buffer, bool msbf, out IControlArg service)
        {
            if (buffer.Length < 5) {
                ...
                Log.Dlt.TraceEvent(TraceEventType.Warning,
                    "Control message 'SetDefaultLogLevelResponse' with insufficient buffer length of {0} (needed 5)",
                    buffer.Length);
                return -1;
            }
