namespace RJCP.Diagnostics.Log.Dlt.Control
{
    ...
    /// </summary>
    public class GetMessageFilteringStatusResponseDecoder : IControlArgDecoder
    {
        /// <summary>
        ...
        public int Decode(int serviceId, ReadOnlySpan<byte> buffer, bool msbf, out IControlArg service)
        {
            if (buffer.Length < 6) {
                ...
                Log.Dlt.TraceEvent(TraceEventType.Warning,
                    "Control message 'GetMessageFilteringStatusResponse' with insufficient buffer length of {0} (needed 6)",
                    buffer.Length);
                return -1;
            }
