namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="SetUseExtendedHeaderRequest"/>.
    /// </summary>
    public sealed class SetUseExtendedHeaderRequestEncoder : ControlArgEncoderBase
    {
        /// <summary>
        ...
        {
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'SetUseExtendedHeaderRequestEncoder' insufficient buffer"));

            SetUseExtendedHeaderRequest controlArg = (SetUseExtendedHeaderRequest)arg;
