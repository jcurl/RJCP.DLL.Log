namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="GetMessageFilteringStatusResponse"/>.
    /// </summary>
    public sealed class GetMessageFilteringStatusResponseEncoder : ControlArgResponseEncoder
    {
        /// <summary>
        ...
        protected override Result<int> EncodePayload(Span<byte> buffer, bool msbf, ControlResponse arg)
        {
            ...
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'GetMessageFilteringStatusResponseEncoder' insufficient buffer"));

            GetMessageFilteringStatusResponse controlArg = (GetMessageFilteringStatusResponse)arg;
