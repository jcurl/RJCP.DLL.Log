namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="GetUseEcuIdResponse"/>.
    /// </summary>
    public sealed class GetUseEcuIdResponseEncoder : ControlArgResponseEncoder
    {
        /// <summary>
        ...
        protected override Result<int> EncodePayload(Span<byte> buffer, bool msbf, ControlResponse arg)
        {
            ...
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'GetUseEcuIdResponseEncoder' insufficient buffer"));

            GetUseEcuIdResponse controlArg = (GetUseEcuIdResponse)arg;
