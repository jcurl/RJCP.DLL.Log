namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="GetVerboseModeStatusResponse"/>.
    /// </summary>
    public sealed class GetVerboseModeStatusResponseEncoder : ControlArgResponseEncoder
    {
        /// <summary>
        ...
        protected override Result<int> EncodePayload(Span<byte> buffer, bool msbf, ControlResponse arg)
        {
            ...
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'GetVerboseModeStatusResponseEncoder' insufficient buffer"));

            GetVerboseModeStatusResponse controlArg = (GetVerboseModeStatusResponse)arg;
