namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="GetDefaultLogLevelResponse"/>.
    /// </summary>
    public sealed class GetDefaultLogLevelResponseEncoder : ControlArgResponseEncoder
    {
        /// <summary>
        ...
        protected override Result<int> EncodePayload(Span<byte> buffer, bool msbf, ControlResponse arg)
        {
            ...
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'GetDefaultLogLevelResponseEncoder' insufficient buffer"));

            GetDefaultLogLevelResponse controlArg = (GetDefaultLogLevelResponse)arg;
