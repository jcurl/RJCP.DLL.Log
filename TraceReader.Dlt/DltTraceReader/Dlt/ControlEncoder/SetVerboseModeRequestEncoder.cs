namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="SetVerboseModeRequest"/>.
    /// </summary>
    public sealed class SetVerboseModeRequestEncoder : ControlArgEncoderBase
    {
        /// <summary>
        ...
        {
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'SetVerboseModeRequestEncoder' insufficient buffer"));

            SetVerboseModeRequest controlArg = (SetVerboseModeRequest)arg;
