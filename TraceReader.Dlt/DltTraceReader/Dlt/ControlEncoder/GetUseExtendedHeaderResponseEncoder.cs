namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    /// <summary>
    /// Encode a <see cref="GetUseExtendedHeaderResponse"/>.
    /// </summary>
    public sealed class GetUseExtendedHeaderResponseEncoder : ControlArgResponseEncoder
    {
        /// <summary>
        ...
        protected override Result<int> EncodePayload(Span<byte> buffer, bool msbf, ControlResponse arg)
        {
            ...
            if (buffer.Length < 1)
                return Result.FromException<int>(new DltEncodeException("'GetUseExtendedHeaderResponseEncoder' insufficient buffer"));

            GetUseExtendedHeaderResponse controlArg = (GetUseExtendedHeaderResponse)arg;
