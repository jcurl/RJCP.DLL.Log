namespace RJCP.Diagnostics.Log.Dlt.ControlArgs
{
    ...
    public sealed class SetVerboseModeResponse : ControlResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetVerboseModeResponse"/> class.
        /// </summary>
        /// <param name="status">The status code for the response.</param>
        public SetVerboseModeResponse(int status) : base(status) { }
        ...
        {
            return string.Format("[set_verbose_mode {0}]", ToString(Status));
        }
    }
}
