namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    [TestFixture(typeof(SetUseEcuIdRequestEncoder), EncoderType.Argument, Endianness.Big)]
    [TestFixture(typeof(SetUseEcuIdRequestEncoder), EncoderType.Argument, Endianness.Little)]
    ...
    public class SetUseEcuIdRequestEncoderTest<TControlEncoder>
        : ControlEncoderTestBase<TControlEncoder> where TControlEncoder : IControlArgEncoder
    {
        public SetUseEcuIdRequestEncoderTest(EncoderType encoderType, Endianness endianness)
