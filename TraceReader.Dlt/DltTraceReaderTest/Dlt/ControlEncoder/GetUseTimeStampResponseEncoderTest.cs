namespace RJCP.Diagnostics.Log.Dlt.ControlEncoder
{
    ...
    [TestFixture(typeof(GetUseTimeStampResponseEncoder), EncoderType.Argument, Endianness.Big)]
    [TestFixture(typeof(GetUseTimeStampResponseEncoder), EncoderType.Argument, Endianness.Little)]
    ...
    public class GetUseTimeStampResponseEncoderTest<TControlEncoder>
        : ControlEncoderTestBase<TControlEncoder> where TControlEncoder : IControlArgEncoder
    {
        public GetUseTimeStampResponseEncoderTest(EncoderType encoderType, Endianness endianness)
