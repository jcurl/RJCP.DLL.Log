namespace RJCP.Diagnostics.Log.Dlt.Control
{
        ...
        : ControlDecoderTestBase<BufferOverflowNotificationRequestDecoder, BufferOverflowNotificationResponseDecoder>
    {
        ...
        {
            byte[] payload = Endian == Endianness.Little ?
                new byte[] { 0x23, 0x00, 0x00, 0x00, status, 0x00, 0x00, 0x00, 0x00 } :
                new byte[] { 0x00, 0x00, 0x00, 0x23, status, 0x00, 0x00, 0x00, 0x00 };
        ...
        {
            byte[] payload = Endian == Endianness.Little ?
                new byte[] { 0x23, 0x00, 0x00, 0x00, status, 0x10, 0x27, 0x00, 0x00 } :
                new byte[] { 0x00, 0x00, 0x00, 0x23, status, 0x00, 0x00, 0x27, 0x10 };
        ...
        {
            byte[] payload = Endian == Endianness.Little ?
                new byte[] { 0x23, 0x00, 0x00, 0x00, status, 0xFF, 0xFF, 0xFF, 0xFF } :
                new byte[] { 0x00, 0x00, 0x00, 0x23, status, 0xFF, 0xFF, 0xFF, 0xFF };
