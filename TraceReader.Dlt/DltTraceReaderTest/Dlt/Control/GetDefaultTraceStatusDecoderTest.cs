namespace RJCP.Diagnostics.Log.Dlt.Control
{
    ...
    {
        public GetDefaultTraceStatusDecoderTest(DecoderType decoderType)
            : base(decoderType, 0x15, typeof(GetDefaultTraceStatusRequest), typeof(GetDefaultTraceStatusResponse))
        { }

        [Test]
        public void DecodeRequest()
        {
            byte[] payload = new byte[] { 0x15, 0x00, 0x00, 0x00 };
        ...
        {
            byte[] payload = new byte[] { 0x15, 0x00, 0x00, 0x00, status, enabled };
