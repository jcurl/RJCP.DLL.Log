namespace RJCP.Diagnostics.Log.Dlt.Control
{
    ...
    {
        public CustomTimeZoneDecoderTest(DecoderType decoderType)
            : base(decoderType, 0x0F03, null, typeof(CustomTimeZoneResponse))
        { }
        ...
        public void DecodeResponsePositiveTz(byte status, byte isDst, string result)
        {
            byte[] payload = new byte[] {
                0x03, 0x0F, 0x00, 0x00, status, 0xA0, 0x8C, 0x00, 0x00, isDst
            };
        ...
        {
            byte[] payload = new byte[] {
                0x03, 0x0F, 0x00, 0x00, status, 0x1C, 0x89, 0x00, 0x00, isDst
            };
        ...
        {
            byte[] payload = new byte[] {
                0x03, 0x0F, 0x00, 0x00, status, 0xB0, 0xB9, 0xFF, 0xFF, isDst
            };
        ...
        {
            byte[] payload = new byte[] {
                0x03, 0x0F, 0x00, 0x00, status, 0x98, 0xA4, 0xFF, 0xFF, isDst
            };
        ...
        {
            byte[] payload = new byte[] {
                0x03, 0x0F, 0x00, 0x00, status, 0x00, 0x00, 0x00, 0x00, isDst
            };
