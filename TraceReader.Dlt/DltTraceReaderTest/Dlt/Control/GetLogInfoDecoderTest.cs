namespace RJCP.Diagnostics.Log.Dlt.Control
{
    ...
    {
        public GetLogInfoDecoderTest(DecoderType decoderType, Endianness endian)
            : base(decoderType, endian, 0x03, typeof(GetLogInfoRequest), typeof(GetLogInfoResponse))
        { }
        ...
        {
            byte[] payload = Endian == Endianness.Little ?
                new byte[] { 0x03, 0x00, 0x00, 0x00, status, 0x65, 0x74, 0x68, 0x30 } :
                new byte[] { 0x00, 0x00, 0x00, 0x03, status, 0x65, 0x74, 0x68, 0x30 };
        ...
        public void DecodeResponseLevelNoTrace_4(byte logLevel, string result)
        {
            byte[] payload = Endian == Endianness.Little ?
                ...
                new byte[] {
                    ...
                    0x00, 0x01, 0x41, 0x50, 0x50, 0x31, 0x00, 0x01, 0x43, 0x54, 0x58, 0x31, logLevel,
                    0x65, 0x74, 0x68, 0x30
                };
        ...
        public void DecodeResponseNoLevelTrace_5(byte traceStatus, string result)
        {
            byte[] payload = Endian == Endianness.Little ?
                ...
                new byte[] {
                    ...
                    0x00, 0x01, 0x41, 0x50, 0x50, 0x31, 0x00, 0x01, 0x43, 0x54, 0x58, 0x31, traceStatus,
                    0x65, 0x74, 0x68, 0x30
                };
        ...
        public void DecodeResponseLevelTrace_6(byte logLevel, byte traceStatus, string result)
        {
            byte[] payload = Endian == Endianness.Little ?
                ...
                new byte[] {
                    0x00, 0x00, 0x00, 0x03, 0x06,
                    0x00, 0x01, 0x41, 0x50, 0x50, 0x31, 0x00, 0x01, 0x43, 0x54, 0x58, 0x31, logLevel, traceStatus,
                    0x65, 0x74, 0x68, 0x30
                };
        ...
        public void DecodeResponseFull_7()
        {
            byte[] payload = Endian == Endianness.Little ?
                ...
                new byte[] {
                    ...
                    0x00, 0x01, 0x41, 0x50, 0x50, 0x31, 0x00, 0x01, 0x43, 0x54, 0x58, 0x31, 0xFF, 0xFF,
                    0x00, 0x15, 0x73, 0x74, 0x64, 0x69, 0x6E, 0x20, 0x61, 0x64, 0x61, 0x70, 0x74, 0x6F, 0x72, 0x20, 0x63, 0x6F, 0x6E, 0x74, 0x65, 0x78, 0x74,
                    0x00, 0x19, 0x73, 0x74, 0x64, 0x69, 0x6E, 0x20, 0x61, 0x64, 0x61, 0x70, 0x74, 0x6F, 0x72, 0x20, 0x61, 0x70, 0x70, 0x6C, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6F, 0x6E,
                    0x65, 0x74, 0x68, 0x30
                };
        ...
        public void DecodeResponseFullNoAppIds()
        {
            ...
            Decode(DltType.CONTROL_RESPONSE, payload, "0x03_GetLogInfoResponse_07_NoAppIds", out IControlArg service);
        ...
        public void DecodeResponseFullMultiple()
        {
            byte[] payload = Endian == Endianness.Little ?
                ...
                new byte[] {
                    0x00, 0x00, 0x00, 0x03, 0x07,
                    0x00, 0x03,  // 3 applications

                    0x41, 0x50, 0x50, 0x31,
                    0x00, 0x03,  // App1; 3 context id's
                    0x43, 0x54, 0x58, 0x31, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x31,
                    0x43, 0x54, 0x58, 0x32, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x32,
                    0x43, 0x54, 0x58, 0x33, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x33,
                    0x00, 0x06, 0x41, 0x44, 0x65, 0x73, 0x63, 0x31,

                    0x41, 0x50, 0x50, 0x32,
                    0x00, 0x02,  // App2; 2 context id's
                    0x43, 0x54, 0x58, 0x34, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x34,
                    0x43, 0x54, 0x58, 0x35, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x35,
                    0x00, 0x06, 0x41, 0x44, 0x65, 0x73, 0x63, 0x32,

                    0x41, 0x50, 0x50, 0x33,
                    0x00, 0x04,  // App3; 4 context id's
                    0x43, 0x54, 0x58, 0x36, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x36,
                    0x43, 0x54, 0x58, 0x37, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x37,
                    0x43, 0x54, 0x58, 0x38, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x38,
                    0x43, 0x54, 0x58, 0x39, 0xFF, 0xFF,
                    0x00, 0x05, 0x54, 0x65, 0x73, 0x74, 0x39,
                    0x00, 0x06, 0x41, 0x44, 0x65, 0x73, 0x63, 0x33,
